<ul class="navbar-nav bg-gradient-dark sidebar sidebar-dark accordion " id="accordionSidebar">
    ...
    <li class="nav-item {{ active_route('dashboard.clients.*') }}">
        ...
        <div id="collapseclients" class="collapse" aria-labelledby="headingclients" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <a class="collapse-item {{ active_route('dashboard.clients.create') }}" href="{{ route('dashboard.clients.create') }}">@lang('main.add') @lang('main.clients')</a>
                <a class="collapse-item {{ active_route('dashboard.clients.index') }}" href="{{ route('dashboard.clients.index') }}">@lang('main.show_all') @lang('main.clients')</a>
                <a class="collapse-item text-danger {{ active_route('dashboard.clients.trashed') }}" href="{{ route('dashboard.clients.trashed') }}">@lang('main.trashed')</a>
            </div>
        </div>
    </li>
