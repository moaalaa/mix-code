...
class CitiesDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables($query)
            ...
            ->addColumn('show', 'dashboard.cities.buttons.show')
            ->addColumn('edit', 'dashboard.cities.buttons.edit')
            ->addColumn('delete', 'dashboard.cities.buttons.delete')
        ...
        $selectFields = [
            [
                ...
                'selectValues' => [
                    ...
                    City::INACTIVE_STATUS    => trans('main.disable'),
                ]
            ],
        ];
