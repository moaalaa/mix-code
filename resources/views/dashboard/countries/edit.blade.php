...
@section('content')
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <div>
            <a href="{{ route('dashboard.countries.show', $country) }}" class="d-sm-inline-block btn btn-sm btn-info shadow-sm">
                    ...
                    <div class="card-text">
                        <form action="{{ route('dashboard.countries.update', $country) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group my-4 row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="en_name" value="{{ $country->en_name }}" id="en_name" class="form-control @error('en_name') is-invalid @enderror" placeholder="@lang('main.en_name')" required>
                            ...
                            <div class="form-group mb-4 row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="ar_name" value="{{ $country->ar_name }}" id="ar_name" class="form-control @error('ar_name') is-invalid @enderror" placeholder="@lang('main.ar_name')" required>
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <div class="fileinput fileinput-new" data-provides="fileinput">
                                        <div class="fileinput-preview thumbnail" data-trigger="fileinput">
                                            <img src="{{ $country->mainMediaUrl() }}" alt="{{ $country->name_by_lang }}" /> 
                                        </div>
                                        <div>
                            ...
                            <div class="form-group row">
                                <div class="col-sm-10">
                                    <button type="submit" class="btn btn-info">@lang('main.edit') @lang('main.country')</button>
                                </div>
                            </div>
                        </form>
                    </div>
