...
class LanguagesTrashedDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables($query)
            ...
            ->addColumn('restore', 'dashboard.languages.buttons.restore')
            ->addColumn('delete', 'dashboard.languages.buttons.force_delete')
