...
class ServicesTrashedDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables($query)
            ...
            ->addColumn('restore', 'dashboard.services.buttons.restore')
            ->addColumn('delete', 'dashboard.services.buttons.force_delete')
