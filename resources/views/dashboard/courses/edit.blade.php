...
@section('content')
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <div>
            <a href="{{ route('dashboard.courses.show', $course) }}" class="d-sm-inline-block btn btn-sm btn-info shadow-sm">
                <i class="fas fa-eye fa-sm text-white-50"></i> 
                @lang('main.show') {{ $course->name_by_lang }}
            </a>
    ...
    <div class="row mb-3">
        ...
        <div class="col-xl-12 col-md-12 col-sm-12">
            <div class="course">
                <div class="course-body border-left-info">
                    <div class="course-title font-weight-bold h5 text-center text-info">{{ $sectionName }}</div>
                    <div class="course-text">
                        <form action="{{ route('dashboard.courses.update', $course) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group my-4 row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="en_name" value="{{ $course->en_name }}" id="en_name" class="form-control @error('en_name') is-invalid @enderror" placeholder="@lang('main.en_name')" required>
                            ...
                            <div class="form-group mb-4 row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="ar_name" value="{{ $course->ar_name }}" id="ar_name" class="form-control @error('ar_name') is-invalid @enderror" placeholder="@lang('main.ar_name')" required>
        ...
        @enderror
                            ...
                            <div class="grid d-flex">
                                ...
                                <div class="grid-col grid-col--4"></div>
                                    ...
                                    <div class="course grid-item image-container">
                                        <img class="course-img portfolio-image" src="{{ $course->mainMediaUrl() }}">
                            ...
                            <div class="form-group row">
                                <div class="col-sm-10">
                                    <button type="submit" class="btn btn-info">@lang('main.edit') @lang('main.course')</button>
                                </div>
                            </div>
                        </form>
                    </div>
