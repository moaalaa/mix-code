...
@section('content')
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <div>
            <a href="{{ route('dashboard.categories.show', $category) }}" class="d-sm-inline-block btn btn-sm btn-info shadow-sm">
                <i class="fas fa-eye fa-sm text-white-50"></i> 
                @lang('main.show') {{ $category->name_by_lang }}
            </a>
                    ...
                    <div class="card-text">
                        <form action="{{ route('dashboard.categories.update', $category) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group my-4 row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="en_name" value="{{ $category->en_name }}" id="en_name" class="form-control @error('en_name') is-invalid @enderror" placeholder="@lang('main.en_name')" required>
                            ...
                            <div class="form-group mb-4 row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="ar_name" value="{{ $category->ar_name }}" id="ar_name" class="form-control @error('ar_name') is-invalid @enderror" placeholder="@lang('main.ar_name')" required>
                            ...
                            {{-- Icon --}}
                            {{-- <div class="form-group mb-4 row">
                                <label class="col-sm-2 col-form-label" for="icon">@lang('main.icon')</label>
                                <div class="col-sm-10">


                                    <div class="fileinput fileinput-new" data-provides="fileinput">
                                        <div class="fileinput-preview thumbnail" data-trigger="fileinput">
                                            <img src="{{ $category->mainMediaUrl('icon') }}" alt="{{ $category->name_by_lang }}" /> 
                                        </div>
                                        <div>
                            ...
                            <div class="form-group row">
                                <div class="col-sm-10">
                                    <button type="submit" class="btn btn-info">@lang('main.edit') @lang('main.category')</button>
                                </div>
                            </div>
                        </form>
                    </div>
